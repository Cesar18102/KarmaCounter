...
namespace KarmaCounter.Validation
{
    public class FormValidator
    {
        public delegate bool ActionPredicate();
        public delegate void ValidationCallback<T>(T obj);
        ...
        public int Add<T>(FieldValidationHandler<T> validationHandler, T validated, ValidationCallback<T> callback)
        {
